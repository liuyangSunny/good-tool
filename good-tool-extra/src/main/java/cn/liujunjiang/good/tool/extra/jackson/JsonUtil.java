 ...
 */
package cn.liujunjiang.good.tool.extra.jackson;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.util.StrUtil;
import cn.liujunjiang.good.tool.extra.exception.Exceptions;
...
public class JsonUtil {
    ...
    public static <T> List<T> parseArray(String content, Class<T> valueTypeRef) {
        try {
            ...
            if (!StrUtil.startWithIgnoreCase(content, StrUtil.BRACKET_START)) {
                content = StrUtil.BRACKET_START + content + StrUtil.BRACKET_END;
            }
